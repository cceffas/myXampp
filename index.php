...
<body class="relative flex flex-col items-center justify-between bg-neutral-900 min-h-screen p-8" id="anim">
	...
	<main class="container min-h-96 mb-16">
		...
		<section class="flex flex-col items-center justify-center flex-wrap mt-20 text-4xl gap-2 p-2">
			<div class="flex flex-col items-center gap-2">
				<img src="public/icon.png" alt="icon-logomark" class=" rounded-full bg-yellow-200">
		...
		<section class="relative flex flex-col mt-20 min-h-96 border-2 border-neutral-800 rounded-md overflow-hidden">
			...
			<div class="flex text-neutral-400 grow">
				<div class="flex flex-col grow">
					...
					<?php foreach ($folders as $folder): ?>
						...
						<?php if (!is_file($path_root . $folder)): ?>
							...
							<a href="<?php echo $uri . 'localhost/' . $folder ?>" target="_blank" class="flex items-center gap-2 p-2 h-8 border-b-2 grow border-b-neutral-800 hover:bg-neutral-800/50 hover:text-orange-500 text-neutral-400" id="item-project">
								<i class="ri-folder-video-fill text-2xl "></i><?php echo $folder; ?>
